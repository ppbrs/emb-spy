...
_irq_descr[25] = (
    "TIM1_UP_TIM10TIM1 Update interrupt and TIM10 global interrupt"  # 2532settable 0x0000 00A4
)
...
def report_nvic(self, bits_data: dict[str, ReaderStaticResult], md_file: MdUtils) -> None:
    ...
    self.report_nvic_stm32(
        bits_data=bits_data, md_file=md_file, irq_num=_irq_num, irq_descr=_irq_descr
    )

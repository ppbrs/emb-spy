...
from emb_spy.analyzer.analyzer_stm32h743._report_basic_timers import report_basic_timers
...
class AnalyzerSTM32H743(Analyzer):
    ...
    def _report(self, bits_data: dict[str, ReaderStaticResult], md_file) -> None:
    ...
    def _report_general(self, bits_data: dict[str, ReaderStaticResult], md_file) -> None:
        ...
        revision = {
            ...
            0x2001: "Revision X",
            0x2003: "Revision V",
        }[bits_data["DBGMCU_IDC.REV_ID"].val]

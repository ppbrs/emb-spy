...
def report_clock(
    ...
    for i in [1, 2, 3]:  # i is PLL index
        ...
        if pll_on and pll_rdy:
            ...
            if not pll_frac_en:
                ...
                ref_freq = {
                    1: self.state.ref1_freq,
                    2: self.state.ref2_freq,
                    3: self.state.ref3_freq,
                }[i]
    ...
    apb1_div = {
        ...
        0b110: 8,
        0b111: 16,
    }[bits_data["RCC_D2CFGR.D2PPRE1"].val]
    ...
    apb2_div = {
        ...
        0b110: 8,
        0b111: 16,
    }[bits_data["RCC_D2CFGR.D2PPRE2"].val]
    ...
    apb3_div = {
        ...
        0b110: 8,
        0b111: 16,
    }[bits_data["RCC_D1CFGR.D1PPRE"].val]
    ...
    apb4_div = {
        ...
        0b110: 8,
        0b111: 16,
    }[bits_data["RCC_D3CFGR.D3PPRE"].val]

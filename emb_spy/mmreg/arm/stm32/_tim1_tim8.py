...
class _Tim1Tim8(Registers):
    ...
    @classmethod
    def init_tim1_tim8(cls, prefix: str, base: int) -> list[Register]:
        return [
            Register(
            ...
            Register(
                name=(f"{prefix}_EGR"), addr=(base + 0x14), descr="TIMx event generation register (write only)",
                register_bits=[
                ]
            ),
            Register(
                name=(f"{prefix}_CCMR1_IN"), addr=(base + 0x18), descr="TIMx capture/compare mode register 1",
                register_bits=[
                ]
            ),
            Register(
                name=(f"{prefix}_CCMR1_OUT"), addr=(base + 0x18), descr="TIMx capture/compare mode register 1",
                register_bits=[
            ...
            Register(
                name=(f"{prefix}_CCMR2_IN"), addr=(base + 0x1C), descr="TIMx capture/compare mode register 2",
                register_bits=[
                ]
            ),
            Register(
                name=(f"{prefix}_CCMR2_OUT"), addr=(base + 0x1C), descr="TIMx capture/compare mode register 2",
                register_bits=[

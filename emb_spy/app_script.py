...
from mmreg.arm.armv6_m.stm32f0.stm32f051 import STM32F051
from emb_spy.socs.bits import Registers  # pylint: disable=import-error
...
if __name__ == "__main__":
    ...
    app = AppScript(elf_path=ELF_PATH, mmregs=STM32H743(), host=HOST, port=PORT)

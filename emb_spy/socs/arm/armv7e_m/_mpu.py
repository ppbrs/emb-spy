        ...
        MmapReg(
            ...
            bits=[
                Bits(
                    bits=range(8, 16),
                    name="DREGION",
                    descr="Indicates the number of supported MPU data regions depending on your implementation",
                ),
                # 0x08 = 8 MPU regions.
                # 0x10 = 16 MPU regions.
            ],
        ...
        MmapReg(
            ...
            bits=[
                ...
                Bits(
                    bits=2,
                    name="PRIVDEFENA",
                    descr="Enables privileged software access to the default memory map",
                ),
                Bits(
                    bits=1,
                    name="HFNMIENA",
                    descr="Enables the operation of MPU during hard fault, NMI, and FAULTMASK handlers",
                ),

...
def init_rcc(self: SoC) -> None:
        ...
        MmapReg(
            ...
            bits=[
                ...
                Bits(
                    bits=14,
                    name="HRTIMSEL",
                    descr="High Resolution Timer clock prescaler selection",
                ),
        ...
        MmapReg(
            ...
            bits=[
                ...
                Bits(
                    bits=range(0, 2),
                    name="PLLSRC",
                    descr="DIVMx and PLLs clock source selection",
    ...
    self.append(
        MmapReg(
            ...
            bits=[
                ...
                Bits(
                    bits=range(16, 17), name="SDMMCSEL", descr="SDMMC kernel clock source selection"
                ),
                ...
                Bits(
                    bits=range(4, 6), name="QSPISEL", descr="QUADSPI kernel clock source selection"
                ),
        ...
        MmapReg(
            ...
            bits=[
                ...
                Bits(
                    bits=[16, 17],
                    name="ADCSEL",
                    descr="SAR ADC kernel clock source selection",
                    descr_vals={
                ...
                Bits(
                    bits=[8, 9],
                    name="I2C4SEL",
                    descr="I2C4 kernel clock source selection",
                    descr_vals={
    ...
    self.append(
        MmapReg(
            name="RCC_APB3RSTR",
            addr=(base + 0x08C),
            descr="RCC APB3 peripheral reset register",
            bits=[
    ...
    self.append(
        MmapReg(
            name="RCC_APB4RSTR",
            addr=(base + 0x09C),
            descr="RCC APB4 peripheral reset register",
            bits=[],
        )
    )
    # ==============================================================================================
    self.append(
        MmapReg(
            name="RCC_AHB1ENR",
            addr=(base + 0x0D8),
            descr="RCC AHB1 Clock Register",
            bits=[
                Bits(bits=28, name="USB2OTGHSULPIEN", descr="Enable USB_PHY2 clocks"),
                Bits(
                    bits=27, name="USB2OTGHSEN", descr="USB2OTG (OTG_HS2) Peripheral Clocks Enable"
                ),
                Bits(bits=26, name="USB1OTGHSULPIEN", descr="USB_PHY1 Clocks Enable"),
                Bits(
                    bits=25, name="USB1OTGHSEN", descr="USB1OTG (OTG_HS1) Peripheral Clocks Enable"
                ),
    ...
    self.append(
        MmapReg(name="RCC_AHB2ENR", addr=(base + 0x0DC), descr="RCC AHB2 Clock Register", bits=[])
    )
    self.append(
        MmapReg(
            name="RCC_AHB3ENR",
            addr=(base + 0x0D4),
            descr="RCC AHB3 Clock Register",
            bits=[
    ...
    self.append(
        MmapReg(
            name="RCC_AHB4RSTR",
            addr=(base + 0x088),
            descr="RCC AHB4 peripheral reset register",
            bits=[

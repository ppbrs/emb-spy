...
def init_tim2_tim3_tim4_tim5(self: SoC) -> None:
    ...
    for pref, base in zip(
        ["TIM2_", "TIM3_", "TIM4_", "TIM5_"], [tim2_base, tim3_base, tim4_base, tim5_base]
    ):
        self.append(
            MmapReg(
                name=(pref + "CR1"),
        ...
        self.append(
            MmapReg(
                name=(pref + "DCR"),
                addr=(base + 0x48),
                descr="TIMx DMA control register",
            )
        )
        self.append(
            MmapReg(
                name=(pref + "DMAR"),
                addr=(base + 0x4C),
                descr="TIMx DMA address for full transfer",
            )
        )
        self.append(
            MmapReg(

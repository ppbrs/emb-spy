...
def init_quadspi(self: SoC) -> None:
    ...
    self.append(
        MmapReg(name="QUADSPI_SR", addr=(base + 0x008), descr="QUADSPI status register", bits=[])
    )
    self.append(
        MmapReg(
            name="QUADSPI_FCR", addr=(base + 0x00C), descr="QUADSPI flag clear register", bits=[]
        )
    )
    self.append(
        MmapReg(
            name="QUADSPI_DLR", addr=(base + 0x010), descr="QUADSPI data length register", bits=[]
        )
    )
    self.append(
        MmapReg(
    ...
    self.append(
        MmapReg(name="QUADSPI_AR", addr=(base + 0x018), descr="QUADSPI address register", bits=[])
    )
    self.append(
        MmapReg(
            name="QUADSPI_ABR",
    ...
    self.append(
        MmapReg(name="QUADSPI_DR", addr=(base + 0x020), descr="QUADSPI data register", bits=[])
    )
    self.append(
        MmapReg(
            name="QUADSPI_PSMKR",

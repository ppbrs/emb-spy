        ...
        MmapReg(
            ...
            bits=[
                Bits(
                    bits=27,
                    name="PC3SO",
                    descr="PC3 to PC3_C Switch Open",
                ),
                ...
                Bits(
                    bits=26,
                    name="PC2SO",
                    descr="PC2 to PC2_C Switch Open",
                ),
                Bits(
                    bits=25,
                    name="PA1SO",
                    descr="PA1 to PA1_C Switch Open",
                ),
                Bits(
                    bits=24,
                    name="PA0SO",
                    descr="PA0 to PA0_C Switch Open",
                ),
                Bits(
                    bits=range(21, 24),
                    name="EPIS",
                    descr="Ethernet PHY Interface Selection",
                ),
                # 000: MII
                # 100: RMII

...
TIM1 and TIM8 are called Advanced-control timers and exist on
* STM32H743
* STM32F745
"""
...
def init_tim1_tim8(self: SoC, prefix: str, base: int) -> None:
        ...
        MmapReg(
            ...
            bits=[
                ...
                Bits(
                    bits=7,
                    name="ARPE",
                    descr="Auto-reload preload enable",
                    descr_vals={
                ...
                Bits(
                    bits=range(5, 6),
                    name="CMS",
                    descr="Center-aligned mode selection",
                    descr_vals={
                ...
                Bits(
                    ...
                    name="DIR",
                    descr="Direction",
                    descr_vals={0: "Counter used as upcounter", 1: "Counter used as downcounter"},
                ),
                Bits(bits=3, name="OPM", descr="One pulse mode"),
                Bits(
                    bits=2,
                    name="URS",
                    descr="Update request source",
                    descr_vals={
        ...
        MmapReg(
            ...
            bits=[
                Bits(
                    bits=range(20, 24),
                    name="MMS2",
                    descr="Master mode selection 2 (TRGO2)",
                    descr_vals={
                ...
                Bits(
                    bits=range(4, 7),
                    name="MMS",
                    descr="Master mode selection (TRGO)",
                    descr_vals={
                ...
                Bits(
                    bits=0,
                    name="CCPC",
                    descr="Capture/compare preloaded control",
                    descr_vals={
    ...
    self.append(
        MmapReg(
            name=(f"{prefix}_SMCR"),
            addr=(base + 0x08),
            descr="TIMx slave mode control register",
            bits=[
                Bits(
                    bits=[0, 1, 2, 16],
                    name="SMS",
                    descr="Slave mode selection",
                    descr_vals={
                ...
                Bits(bits=[4, 5, 6, 20, 21], name="TS", descr="Trigger selection"),
            ],
        )
    )
    self.append(
        ...
        MmapReg(
            ...
            bits=[
                ...
                Bits(
                    bits=11,
                    name="OC2PE",
                    descr="Output Compare 2 preload enable",
                    descr_vals={
                ...
                Bits(
                    bits=[8, 9],
                    name="CC2S",
                    descr="Capture/Compare 2 selection",
                    descr_vals={
                ...
                Bits(
                    bits=3,
                    name="OC1PE",
                    descr="Output Compare 1 preload enable",
                    descr_vals={
                ...
                Bits(
                    bits=[0, 1],
                    name="CC1S",
                    descr="Capture/Compare 1 selection",
                    descr_vals={
                        0b00: "CC1 channel is configured as output",
        ...
        MmapReg(
            ...
            bits=[
                ...
                Bits(
                    bits=11,
                    name="OC4PE",
                    descr="Output Compare 4 preload enable",
                    descr_vals={
                ...
                Bits(
                    bits=[8, 9],
                    name="CC4S",
                    descr="Capture/Compare 4 selection",
                    descr_vals={
                ...
                Bits(
                    bits=3,
                    name="OC3PE",
                    descr="Output Compare 3 preload enable",
                    descr_vals={
                ...
                Bits(
                    bits=[0, 1],
                    name="CC3S",
                    descr="Capture/Compare 3 selection",
                    descr_vals={
    ...
    self.append(
        MmapReg(
            name=(f"{prefix}_CCER"),
            addr=(base + 0x20),
            descr="TIMx capture/compare enable register",
            bits=[
                ...
                Bits(
                    bits=15, name="CC4NP", descr="Capture/Compare 4 complementary output polarity"
                ),
                ...
                Bits(
                    bits=11, name="CC3NP", descr="Capture/Compare 3 complementary output polarity"
                ),
                ...
                Bits(
                    bits=3,
                    name="CC1NP",
                    descr="Capture/Compare 1 complementary output polarity",
                    descr_vals={
                ...
                Bits(
                    bits=1,
                    name="CC1P",
                    descr="Capture/Compare 1 output polarity",
                    descr_vals={
    ...
    self.append(
        MmapReg(
            name=(f"{prefix}_CCR1"),
            addr=(base + 0x34),
            descr="TIMx capture/compare register 1",
            bits=[
    ...
    self.append(
        MmapReg(
            name=(f"{prefix}_CCR2"),
            addr=(base + 0x38),
            descr="TIMx capture/compare register 2",
            bits=[
    ...
    self.append(
        MmapReg(
            name=(f"{prefix}_CCR3"),
            addr=(base + 0x3C),
            descr="TIMx capture/compare register 3",
            bits=[
    ...
    self.append(
        MmapReg(
            name=(f"{prefix}_CCR4"),
            addr=(base + 0x40),
            descr="TIMx capture/compare register 4",
            bits=[
    ...
    self.append(
        MmapReg(
            name=(f"{prefix}_BDTR"),
            addr=(base + 0x44),
            descr="TIMx break and dead-time register",
            bits=[

    ...
    self += [
        ...
        MmapReg(
            ...
            bits=[
                ...
                Bits(
                    bits=range(18, 22),
                    name="PLLMUL",
                    descr="PLL multiplication factor",
                    descr_vals={
        ...
        MmapReg(
            ...
            bits=[
                ...
                Bits(bits=27, name="CRSEN", descr="Clock recovery system interface clock enable"),
        ...
        MmapReg(
            name="RCC_AHBRSTR",
            addr=(base + 0x28),
            descr="AHB peripheral reset register",
            bits=[
        ...
        MmapReg(
            name="RCC_CFGR2",
            addr=(base + 0x2C),
            descr="Clock configuration register 2",
            bits=[],
        ),
        MmapReg(
            name="RCC_CFGR3",
            addr=(base + 0x30),
            descr="Clock configuration register 3",
            bits=[],
        ),
        MmapReg(
            name="RCC_CR2",
            addr=(base + 0x34),
            descr="Clock control register 2",
            bits=[],
        ),
    ]

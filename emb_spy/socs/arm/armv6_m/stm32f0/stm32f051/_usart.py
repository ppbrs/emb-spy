...
def _init_usart_x(self: SoC, idx: int, base: int) -> None:
    ...
    self.append(
        MmapReg(
            name=f"{usart}_CR1",
            addr=(base + 0x00),
            descr="USART control register 1",
            bits=[
    ...
    self.append(
        MmapReg(
            name=f"{usart}_CR2",
            addr=(base + 0x04),
            descr="USART control register 2",
            bits=[
    ...
    self.append(
        MmapReg(
            name=f"{usart}_CR3",
            addr=(base + 0x08),
            descr="USART control register 3",
            bits=[
    ...
    self.append(
        MmapReg(
            name=f"{usart}_BRR",
            addr=(base + 0x0C),
            descr="USART baud rate register",
    ...
    self.append(
        MmapReg(
            name=f"{usart}_GTPR",
            addr=(base + 0x10),
            descr="USART guard time and prescaler register",
            bits=[
    ...
    self.append(
        MmapReg(
            name=f"{usart}_RTOR",
            addr=(base + 0x14),
            descr="USART receiver timeout register",
            bits=[
    ...
    self.append(
        MmapReg(
            name=f"{usart}_ISR",
            addr=(base + 0x1C),
            descr="USART interrupt and status register",
            bits=[
    ...
    self.append(
        MmapReg(
            name=f"{usart}_ICR",
            addr=(base + 0x20),
            descr="USART interrupt flag clear register",
            bits=[
    ...
    self.append(
        MmapReg(
            name=f"{usart}_RDR",
            addr=(base + 0x24),
            descr="USART receive data register",
            bits=[
    ...
    self.append(
        MmapReg(
            name=f"{usart}_TDR",
            addr=(base + 0x28),
            descr="USART transmit data register",
            bits=[

...
def init_systick(self: SoC) -> None:
    ...
    self.append(
        MmapReg(
            name="SYST_CSR",
            addr=0xE000E010,
            descr="SysTick Control and Status Register",
            ...
            bits=[
                ...
                Bits(
                    bits=2,
                    name="CLKSOURCE",
                    descr="Indicates the clock source",
                    descr_vals={
                        0: "External clock.",
                        1: "Processor clock.",
                    },
                ...
                Bits(
                    bits=1,
                    name="TICKINT",
                    descr="Enables SysTick exception request",
                    descr_vals={
    ...
    self.append(
        MmapReg(
            name="SYST_RVR",
            addr=0xE000E014,
            descr="SysTick Reload Value Register",
            bits=[
                Bits(
                    bits=range(0, 24),
                    name="RELOAD",
    ...
    self.append(
        MmapReg(
            name="SYST_CVR",
            addr=0xE000E018,
            descr="SysTick Current Value Register",
            bits=[
    ...
    self.append(
        MmapReg(
            name="SYST_CALIB",
            addr=0xE000E01C,
            descr="SysTick Calibration Value Register",
            bits=[

...
def init_scb(self: SoC) -> None:
    ...
    self.append(MmapReg(name="ICSR", addr=0xE000ED04, descr="Interrupt Control and State Register"))
    self.append(
        MmapReg(
            name="AIRCR",
            addr=0xE000ED0C,
    ...
    self.append(MmapReg(name="CCR", addr=0xE000ED14, descr="Configuration and Control Register"))
    self.append(
        MmapReg(
            name="SHPR2",
            addr=0xE000ED1C,
